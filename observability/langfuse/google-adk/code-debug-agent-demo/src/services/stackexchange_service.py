"""StackExchange API service wrapper for debugging assistance with Langfuse tracing."""
...
class StackExchangeService:
    ...
    @observe(as_type="retriever", name="search_stack_exchange_questions")
    async def search_questions(
        ...
        """Search for questions on Stack Exchange (traced as RAG retriever).
    ...
    @observe(as_type="retriever", name="get_stack_exchange_answers")
