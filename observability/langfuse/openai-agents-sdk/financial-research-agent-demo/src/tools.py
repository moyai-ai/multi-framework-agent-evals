"""
Tool implementations for the Financial Research Agent System with Langfuse Tracing.

This module defines all the function tools that agents can use, with full
Langfuse observability for each tool invocation.
"""
...
async def web_search_tool(query: str) -> str:
    """
    Search for financial information on the web with Langfuse tracing.
...
async def company_financials_tool(
    ...
    """
    Analyze a company's financial metrics with Langfuse tracing.
...
async def risk_analysis_tool(
    ...
    """
    Perform risk analysis for a company with Langfuse tracing.
...
async def market_data_tool(ticker: str) -> str:
    """
    Retrieve current market data for a stock with Langfuse tracing.
