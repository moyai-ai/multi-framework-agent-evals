"""
Agent definitions for the Financial Research Multi-Agent System with Langfuse Tracing.

This module defines 6 specialized agents with full observability:
...
Each agent execution is traced as a separate span in Langfuse for full observability.
"""
