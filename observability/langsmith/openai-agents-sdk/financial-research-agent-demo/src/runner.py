"""
Test runner for executing financial research scenarios with LangSmith tracing.
...
class ScenarioRunner:
    """
    Executes test scenarios with full LangSmith observability.
    """

    def __init__(self, verbose: bool = False):
        """
        Initialize the scenario runner with LangSmith.
    ...
    @traceable(name="run_test_scenario", run_type="chain")
    async def run_scenario(self, scenario: TestScenario) -> ScenarioReport:
        """
        Execute a complete test scenario with LangSmith tracing.
...
async def main():
    """
    Main entry point for running scenarios with LangSmith tracing.
    """
    import argparse

    parser = argparse.ArgumentParser(
        description='Run financial research test scenarios with LangSmith observability'
    )
    parser.add_argument(
        'scenario_file',
        nargs='?',
    ...
    if not os.environ.get('LANGSMITH_API_KEY'):
        ...
        print("Tracing will not work without LangSmith credentials")
