"""
Tool implementations for the Financial Research Agent System with LangSmith Tracing.

This module defines all the function tools that agents can use.
Tool invocations are automatically traced by LangSmith when called by agents.
"""
...
async def web_search_tool(query: str) -> str:
    """
    Search for financial information on the web with LangSmith tracing.
...
async def company_financials_tool(
    ...
    """
    Analyze a company's financial metrics with LangSmith tracing.
...
async def risk_analysis_tool(
    ...
    """
    Perform risk analysis for a company with LangSmith tracing.
...
async def market_data_tool(ticker: str) -> str:
    """
    Retrieve current market data for a stock with LangSmith tracing.
