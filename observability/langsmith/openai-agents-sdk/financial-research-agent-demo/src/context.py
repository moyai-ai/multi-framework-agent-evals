"""
Context models for the Financial Research Agent System.

This module defines the context structure that maintains state throughout
the financial research workflow across multiple agents.
"""
...
class FinancialResearchContext:
    """
    Context for financial research conversations.
...
def create_initial_context(query: str = "", session_id: Optional[str] = None) -> FinancialResearchContext:
    """
    Create a new initial context for a financial research session.
