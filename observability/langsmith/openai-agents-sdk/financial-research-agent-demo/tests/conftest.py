...
def setup_test_environment():
    ...
    # Set mock LangSmith API key for unit tests
    if not os.environ.get("LANGSMITH_API_KEY"):
        os.environ["LANGSMITH_API_KEY"] = "test-langsmith-key-12345-mock-for-unit-tests"
...
@pytest.fixture
def mock_langsmith_api_key(monkeypatch):
    """Mock LangSmith API key for testing."""
    monkeypatch.setenv("LANGSMITH_API_KEY", "test-langsmith-key-12345")
