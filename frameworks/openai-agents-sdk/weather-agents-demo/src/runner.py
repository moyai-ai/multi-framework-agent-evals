...
conversation scenarios for testing the weather agent system.
"""
...
from .context import WeatherAgentContext, create_test_context, context_diff
    ...
    async def execute_turn(
        ...
        try:
            result = await Runner.run(
                ...
                run_config=RunConfig(workflow_name="Weather Agent Workflow")
            )
...
async def main():
    ...
    parser = argparse.ArgumentParser(
        description='Run weather agent test scenarios from JSON files'
    )
    parser.add_argument(
        'scenario_file',
